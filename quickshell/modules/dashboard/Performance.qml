...
RowLayout {
    ...
    component Resource: Item {
        ...
        readonly property real thickness: Config.dashboard.sizes.resourceProgessThickness
        ...
        implicitWidth: Config.dashboard.sizes.resourceSize
        implicitHeight: Config.dashboard.sizes.resourceSize
